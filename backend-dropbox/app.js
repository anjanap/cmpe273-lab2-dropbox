...
app.use('/delete', list.deletefile);
app.use('/updatestar', star.updatestar);
app.use('/starred', star.starred);
app.use('/creategroup', group.creategroup);
app.use('/listgroups', group.listgroups);

var multer=require('multer');
var storage = multer.diskStorage({
    destination: function (req, file, cb) {
        cb(null, '../kafka-backend-dropbox/file_uploads/')
    },
...
app.get('/download/*',function(req,res){
	...
	var path='../kafka-backend-dropbox/file_uploads/'+f;
